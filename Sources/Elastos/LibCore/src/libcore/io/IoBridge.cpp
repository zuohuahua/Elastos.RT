    ...
    /* [in] */ Int32 timeoutMs)
{
    ...
    } while (IsConnected(fd, inetAddress, port, timeoutMs, remainingTimeoutMs, &isflag), !isflag);
    utils->SetBlocking(fd, TRUE); // 4. set the socket back to blocking. // TODO::
    return NOERROR;
}
...
ECode IoBridge::GetSocketOption(
    /* [in] */ IFileDescriptor* fd,
    /* [in] */ Int32 option,
...
ECode IoBridge::GetSocketOptionErrno(
    /* [in] */ IFileDescriptor* fd,
    /* [in] */ Int32 option,
    /* [out] */ IInterface** value)
{
    ...
    case IIoBridge::ELASTOS_IP_MULTICAST_TTL:
    {
        // Since setting this from java.net always sets IPv4 and IPv6 to the same value,
        // it doesn't matter which we return.
        Int32 socketopt;
...
Boolean IoBridge::BooleanFromInt(
    /* [in] */ Int32 i)
{
    return (i != 0);
}

Int32 IoBridge::BooleanToInt(
    /* [in] */ Boolean b)
{
    return b ? 1 : 0;
}

ECode IoBridge::SetSocketOption(
    /* [in] */ IFileDescriptor* fd,
    /* [in] */ Int32 option,
    /* [in] */ IInterface* value)
{
...
ECode IoBridge::SetSocketOptionErrno(
    /* [in] */ IFileDescriptor* fd,
    /* [in] */ Int32 option,
    /* [in] */ IInterface* value)
{
    ...
    case IIoBridge::ELASTOS_MCAST_JOIN_GROUP:
    case IIoBridge::ELASTOS_MCAST_LEAVE_GROUP:
    {
        ...
        Int32 op = (option == IIoBridge::ELASTOS_MCAST_JOIN_GROUP) ?
                IIoBridge::ELASTOS_MCAST_JOIN_GROUP : IIoBridge::ELASTOS_MCAST_LEAVE_GROUP;
        FAIL_RETURN(CLibcore::sOs->SetsockoptGroupReq(fd, level, op, groupReq));
        return NOERROR;
    }
    case IIoBridge::ELASTOS_MCAST_JOIN_SOURCE_GROUP:
    case IIoBridge::ELASTOS_MCAST_LEAVE_SOURCE_GROUP:
    case IIoBridge::ELASTOS_MCAST_BLOCK_SOURCE:
    case IIoBridge::ELASTOS_MCAST_UNBLOCK_SOURCE:
    {
...
Int32 IoBridge::GetGroupSourceReqOp(
    /* [in] */ Int32 value)
{
    switch (value) {
        case IIoBridge::ELASTOS_MCAST_JOIN_SOURCE_GROUP:
...
ECode IoBridge::GetSocketLocalAddress(
    /* [in] */ IFileDescriptor* fd,
...
ECode IoBridge::GetSocketLocalPort(
    /* [in] */ IFileDescriptor* fd,
    /* [out] */ Int32* port)
{
