    ...
    /* [out] */ Node** node)
{
    ...
    *node = NULL;
    ...
    entry->GetKey((IInterface**)&keyface);
    AutoPtr<Node> mine;
    FAIL_RETURN(FindByObject(keyface, (Node**)&mine));
    AutoPtr<IInterface> valueface;
...
ECode CTreeMap::RemoveInternalByKey(
    /* [in] */ IInterface* key,
    /* [out] */ Node** removement)
{
    ...
    /* [out] */ Node** outnode)
{
    ...
    *outnode = NULL;
    ...
    if (mNext != NULL) {
        FAIL_RETURN(mBoundParent->IsInBounds(mNext->mKey, NO_BOUND, mBoundParent->mToBound, &isinbounds));
        if (!isinbounds){
            mNext = NULL;
        }
    }
    ...
    /* [out] */ Node** outnode)
{
    ...
    *outnode = NULL;
    ...
    if (mNext != NULL) {
        FAIL_RETURN(mBoundParent->IsInBounds(mNext->mKey, mBoundParent->mFromBound, NO_BOUND, &isinbounds));
        if(!isinbounds){
            mNext = NULL;
        }
    }
    ...
    /* [out] */ IIterator** outiter)
{
    ...
    *outiter = new BoundedEntrySetIterator(outnode, mHost);
    REFCOUNT_ADD(*outiter);
    return NOERROR;
}
    ...
    /* [out] */ Boolean* value)
{
    ...
    *value = FALSE;
    ...
    AutoPtr<Node> node;
    Boolean isinbounds = FALSE;
    FAIL_RETURN(mHost->mHost->FindByEntry(entry, (Node**)&node));
    FAIL_RETURN(mHost->IsInBounds(keyface, &isinbounds));
    *value = isinbounds && node != NULL;
    return NOERROR;
}
    ...
    /* [out] */ Boolean* value)
{
    ...
    *value = FALSE;
    ...
    Boolean isinbounds = FALSE;
    FAIL_RETURN(mHost->IsInBounds(keyface, &isinbounds));
    *value = isinbounds && ((ICollection::Probe(entries))->Remove(entry, &isflag), isflag);
    return NOERROR;
}
    ...
    /* [out] */ IIterator** outiter)
{
    ...
    *outiter = NULL;
    ...
    AutoPtr<Node> outnode;
    FAIL_RETURN(mHost->Endpoint(TRUE, (Node**)&outnode));
    *outiter = new BoundedKeySetIterator(outnode, mHost);
    REFCOUNT_ADD(*outiter);;
    return NOERROR;
}
    ...
    /* [out] */ Boolean* value)
{
    ...
    *value = FALSE;
    ...
    Boolean isinbounds = FALSE;
    FAIL_RETURN(mHost->IsInBounds(o, &isinbounds));
    *value = isinbounds && node != NULL;
    return NOERROR;
}
    ...
    /* [out] */ PInterface* value)
{
    ...
    *value = NULL;
    ...
    if (isinbounds) {
        mHost->Get(key, (IInterface**)&keyface);
        *value = keyface;
    }
    else
        *value = NULL;
    ...
    /* [out] */ Boolean* result)
{
    ...
    *result = FALSE;
    ...
    FAIL_RETURN(IsInBounds(key, &isinbounds));
    FAIL_RETURN(mHost->ContainsKey(key, &isflag));

    if (isinbounds && isflag)
        *result = TRUE;
    ...
    /* [out] */ PInterface* value)
{
    ...
    *value = NULL;
    ...
    if (isinbounds) {
        mHost->Remove(key, (IInterface**)&res);
        *value = res;
    }
    else
        *value = NULL;
...
ECode CTreeMap::BoundedMap::IsInBounds(
    /* [in] */ IInterface* key,
    /* [out] */ Boolean* result)
{
    return IsInBounds(key, mFromBound, mToBound, result);
}
...
ECode CTreeMap::BoundedMap::GetBound(
    /* [in] */ Node* node,
    /* [in] */ Bound fromBound,
    /* [in] */ Bound toBound,
    /* [out] */ Node** outnode)
{
    ...
    *outnode = NULL;
    ...
    Boolean isinbounds = FALSE;
    if (node != NULL){
        FAIL_RETURN(IsInBounds((node->GetKey((IInterface**)&keyface), keyface), fromBound, toBound, &isinbounds));
        if (isinbounds){
            res = node;
        }
    }
    ...
    /* [out] */ IInterface** outface)
{
    ...
    *outface = NULL;
    ...
    AutoPtr<Node> outnode;
    ECode ec;
    ec = Endpoint(TRUE, (Node**)&outnode);
    if (FAILED(ec) || (outnode == NULL)) {
        // throw new NoSuchElementException();
        return E_NO_SUCH_ELEMENT_EXCEPTION;
    }
    ...
    /* [out] */ IInterface** outface)
{
    ...
    *outface = NULL;
    ...
    ec = Endpoint(FALSE, (Node**)&outnode);
    if (FAILED(ec) || (outnode == NULL)) {
        // throw new NoSuchElementException();
        return E_NO_SUCH_ELEMENT_EXCEPTION;
    }
 ...
 */
ECode CTreeMap::BoundedMap::Endpoint(
    /* [in] */ Boolean first,
    /* [out] */ Node** outnode)
{
    VALIDATE_NOT_NULL(outnode)
        ...
        switch (mFromBound) {
            case NO_BOUND:
                if (mHost->mRoot == NULL)
                    ...
                    node = mHost->mRoot->GetFirst();
                break;
            case INCLUSIVE:
                FAIL_RETURN(mHost->Find(mFrom, CEILING, (Node**)&node));
                break;
            case EXCLUSIVE:
                FAIL_RETURN(mHost->Find(mFrom, HIGHER, (Node**)&node));
                break;
            default:
                // throw new AssertionError();
                return NOERROR;
        ...
        switch (mToBound) {
            case NO_BOUND:
                if (mHost->mRoot == NULL)
                    ...
                    node = mHost->mRoot->GetLast();
                break;
            case INCLUSIVE:
                FAIL_RETURN(mHost->Find(mTo, FLOOR, (Node**)&node));
                break;
            case EXCLUSIVE:
                FAIL_RETURN(mHost->Find(mTo, LOWER, (Node**)&node));
                break;
            default:
                // throw new AssertionError();
                return NOERROR;
 ...
 */
ECode CTreeMap::BoundedMap::FindBounded(
    /* [in] */ IInterface* key,
    /* [in] */ Relation relation,
    /* [out] */ IMapEntry** outent)
{
    ...
    *outent = NULL;
    ...
    if (mToBound != NO_BOUND && (relation == LOWER || relation == FLOOR)) {
        Int32 comparison = 0;
        FAIL_RETURN(mHost->mComparator->Compare(mTo, key, &comparison));
        if (comparison <= 0) {
            key = mTo;
    ...
    if (mFromBound != NO_BOUND && (relation == CEILING || relation == HIGHER)) {
        Int32 comparison = 0;
        FAIL_RETURN(mHost->mComparator->Compare(mFrom, key, &comparison));
        if (comparison >= 0) {
            key = mFrom;
    ...
    /* [out] */ INavigableMap** outnav)
{
    ...
    *outnav = NULL;
    ...
    Bound toBound = toInclusive ? INCLUSIVE : EXCLUSIVE;
    AutoPtr<INavigableMap> res;
    FAIL_RETURN(SubMap(fromKey, fromBound, toKey, toBound, (INavigableMap**)&res));
    *outnav = res;
    REFCOUNT_ADD(*outnav)
    return NOERROR;
}
    ...
    /* [out] */ INavigableMap** outnav)
{
    ...
    *outnav = NULL;
    ...
    Bound toBound = inclusive ? INCLUSIVE : EXCLUSIVE;
    AutoPtr<INavigableMap> res;
    FAIL_RETURN(SubMap(NULL, NO_BOUND, toKey, toBound, (INavigableMap**)&res));
    *outnav = res;
    REFCOUNT_ADD(*outnav)
    return NOERROR;
}
    ...
    /* [out] */ INavigableMap** outnav)
{
    ...
    *outnav = NULL;
    ...
    Bound fromBound = inclusive ? INCLUSIVE : EXCLUSIVE;
    AutoPtr<INavigableMap> res;
    FAIL_RETURN(SubMap(fromKey, fromBound, NULL, NO_BOUND, (INavigableMap**)&res));
    *outnav = res;
    REFCOUNT_ADD(*outnav)
    return NOERROR;
}
    ...
    /* [out] */ INavigableMap** outnav)
{
    ...
    *outnav = NULL;
    ...
    if (fromBound == NO_BOUND) {
        ...
        FAIL_RETURN(IsInBounds(from, fromBoundToCheck, mToBound, &isinbounds))
        if (!isinbounds) {
    ...
    if (toBound == NO_BOUND) {
        ...
        FAIL_RETURN(IsInBounds(to, mFromBound, toBoundToCheck, &isinbounds));
        if (!isinbounds) {
