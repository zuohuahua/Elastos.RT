...
public:
    ...
    public:
         ...
         */
        CARAPI_(Boolean) NonfairTryAcquire(
            /* [in] */ Int32 acquires);

        AutoPtr<AbstractQueuedSynchronizer::ConditionObject> NewCondition();

        // Methods relayed from outer class
        CARAPI_(AutoPtr<IThread>) GetOwner();

        CARAPI_(Int32) GetHoldCount();

        CARAPI_(Boolean) IsLocked();
...
#endif //__ELASTOS_UTILITY_CONCURRENT_LOCKS_ELASTOS_UTILITY_REENTRANTLOCK_H__
