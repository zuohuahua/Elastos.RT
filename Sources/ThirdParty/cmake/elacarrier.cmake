...
if("$ENV{XDK_TARGET_PLATFORM}" STREQUAL "android")
    ...
    set (ELACARRIER_CMD COMMAND ANDROID_NDK_HOME=$ENV{ANDROID_NDK} PATH=${ELACARRIER_BINARY_DIR}/build/flatcc-0.5.0/bin:$ENV{PATH} ./android_build.sh ${ELACARRIER_OS_ARCH} ${ELACARRIER_COMPILE_VERSION})
