...
extern "C" JNIEXPORT void JNICALL Java_org_elastos_generatejavaserver_MainActivity_stopCarrier(
        JNIEnv *env,
        jobject jobj) {
...
extern "C" JNIEXPORT jint JNICALL Java_org_elastos_generatejavaserver_MainActivity_addFriend(
        JNIEnv *env,
        jobject jobj,
        jstring uid) {
...
extern "C" JNIEXPORT jint JNICALL Java_org_elastos_generatejavaserver_MainActivity_deleteFriend(
        JNIEnv *env,
        jobject jobj,
        jstring uid) {
    if (gCarrier == NULL) return -1;
...
extern "C" JNIEXPORT jobject JNICALL Java_org_elastos_generatejavaserver_MainActivity_getFriendList(
        JNIEnv *env,
        jobject jobj) {
    ...
    jclass cls_friend = env->FindClass("org/elastos/generatejavaserver/Friend");
...
extern "C" JNIEXPORT jint JNICALL Java_org_elastos_generatejavaserver_MainActivity_acceptFriend(
        JNIEnv *env,
        jobject jobj,
        jstring uid) {
    if (gCarrier == NULL) return -1;
...
extern "C" JNIEXPORT jstring JNICALL Java_org_elastos_generatejavaserver_MainActivity_getAddress(
        JNIEnv *env,
        jobject jobj) {
...
extern "C" JNIEXPORT void JNICALL Java_org_elastos_generatejavaserver_MainActivity_startServiceManager(
        JNIEnv *env,
        jobject jobj) {
    if (gCarrier == NULL) return;
...
extern "C" JNIEXPORT void JNICALL Java_org_elastos_generatejavaserver_MainActivity_stopServiceManager(
        JNIEnv *env,
        jobject jobj) {
    if (gServiceManager) {
...
extern "C" JNIEXPORT jint JNICALL Java_org_elastos_generatejavaserver_MainActivity_addService(
        JNIEnv *env,
        jobject jobj,
        jstring name,
        jobject jhellojava) {
    ...
    ECode ec = gServiceManager->AddService(String(nativeString), pHelloJava);
    env->ReleaseStringUTFChars(name, nativeString);
    return ec;
}

extern "C" JNIEXPORT jint JNICALL Java_org_elastos_generatejavaserver_MainActivity_getService(
        JNIEnv *env,
        jobject jobj,
        jstring uid,
        jstring name) {
...
extern "C" JNIEXPORT jstring JNICALL Java_org_elastos_generatejavaserver_MainActivity_hello(
        JNIEnv *env,
        jobject jobj,
        jstring uid) {
