...
import org.elastos.GenerateJava.CHelloJava;
...
public class MainActivity extends AppCompatActivity {
  ...
  private static CHelloJava sHelloJava = null;
  ...
  private void handleConnectionChanged(Message msg) {
    ...
    if (connected) {
      ...
      startServiceManager();
      if (sHelloJava == null) {
        sHelloJava = new CHelloJava();
        int ret = addService("s", sHelloJava);
  ...
  private native int addService(String name, CHelloJava helloJava);
